...
def hog(image, orientations=9, pixels_per_cell=(8, 8), cells_per_block=(1, 1),
    ...
    block_norm : None or str {'L1', 'L1-sqrt', 'L2', 'L2-Hys'}, optional
        ...
        None: to avoid block normalization
